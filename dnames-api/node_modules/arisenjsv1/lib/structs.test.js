...
describe('shorthand', function () {
  ...
  it('authority', function () {
    var rsn = Rsn();
    var authority = rsn.fc.structs.authority;


    var pubkey = 'RSN6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV';
  ...
  it('PublicKey sorting', function () {
    ...
    var pubkeys = ['RSN7wBGPvBgRVa4wQN2zm5CjgBF6S7tP7R3JavtSa2unHUoVQGhey', 'RSN6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV'];
  ...
  it('symbol', function () {
    var rsn = Rsn();
    var types = rsn.fc.types;

    var _Symbol = types.symbol();
    assertSerializer(_Symbol, '4,RSN', '4,RSN', 'RSN');
  });

  it('extended_symbol', function () {
    var rsn = Rsn({ defaults: true });
    var esType = rsn.fc.types.extended_symbol();
  ...
  it('extended_asset', function () {
    var rsn = Rsn({ defaults: true });
    var eaType = rsn.fc.types.extended_asset();
...
if (process.env['NODE_ENV'] === 'development') {
  ...
  describe('Rsnio Abi', function () {

    it('Rsnio token contract parses', function (done) {
      var rsn = Rsn();

      rsn.contract('arisen.token', function (error, arisen_token) {
        assert(!error, error);
...
describe('Action.data', function () {
  it('json', function () {
    var rsn = Rsn({ forceActionDataHex: false });
    var _rsn$fc2 = rsn.fc,
        structs = _rsn$fc2.structs,
        types = _rsn$fc2.types;
  ...
  it('force hex', function () {
    var rsn = Rsn({ forceActionDataHex: true });
    var _rsn$fc3 = rsn.fc,
        structs = _rsn$fc3.structs,
        types = _rsn$fc3.types;
  ...
  it('unknown type', function () {
    var rsn = Rsn({ forceActionDataHex: false });
    var _rsn$fc4 = rsn.fc,
        structs = _rsn$fc4.structs,
        types = _rsn$fc4.types;
